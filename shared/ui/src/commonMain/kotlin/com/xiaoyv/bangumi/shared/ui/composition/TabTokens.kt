...
import com.xiaoyv.bangumi.core_resource.resources.index_advance
...
//        createFeature(FeatureType.TYPE_PIXIV, Res.drawable.ic_pixiv),
    ...
    val mainHomeIndexFilters = persistentListOf(
        ...
        ComposeTextTab(IndexHomepageType.ADVANCE, Res.string.index_advance),
...
//        ComposeTextTab(TimelineCat.WINDOW, Res.string.timeline_window),
    ...
    val settingBottomBarAppearanceItems = persistentListOf(
        ComposeTextTab(SettingBottomBarAppearance.MATERIAL3, Res.string.settings_bar_appearance_material3),
        ComposeTextTab(SettingBottomBarAppearance.LIQUID_GLASS, Res.string.settings_bar_appearance_liquid_glass),
    )
